...
class GAN:
    ...
    def Generator(self):
        ...
        # x = layers.sis2_dense_multireceptive_field(x, kernel_sizes=[3, 5, 9, 13], filters=64)
        # concat_x = x

        x1 = layers.sis2_pix2pix(x, self.exp.TILESIZE, 64, kernel_size=3)
        x2 = layers.sis2_pix2pix(x, self.exp.TILESIZE, 64, kernel_size=5)
        x3 = layers.sis2_pix2pix(x, self.exp.TILESIZE, 64, kernel_size=9)
