...
class GAN:
    ...
    def Generator(self):
        ...
        x = layers.conv(5, 64, 4, lrelu=True, batchnorm=False)(x)           # 64,64,64
        skip64 = x
        x = layers.conv(5, 128, 4, lrelu=True, batchnorm=True)(x)           # 16,16,128
        skip16 = x
        x = layers.conv(3, 256, 4, lrelu=True, batchnorm=True)(x)           # 4,4,256
        skip4 = x
        x = layers.conv(3, 512, 2, lrelu=True, batchnorm=True)(x)           # 2,2,512
        skip2 = x
        x = layers.conv(3, 512, 2, lrelu=True, batchnorm=True)(x)           # 1,1,512
