...
outputfolder="/home/ucabcbo/output/"$datetime"_"$1"_alt/"
mkdir $outputfolder

source /home/ucabcbo/sis2/venv/bin/activate
if [ -z "$2" ]; then
    python /home/ucabcbo/sis2/train_alt.py --exp $1 --out $outputfolder > $outputfolder"nohup.out"
else
    python /home/ucabcbo/sis2/train_alt.py --exp $1 --restore $2 --out $outputfolder > $outputfolder"nohup.out"
fi
